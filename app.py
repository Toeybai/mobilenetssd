...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
            ...
            replyObj = TextSendMessage(text="หรงหรง")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "เป็นเก้าอี้":
            replyObj = TextSendMessage(text="ต้องมีสี่ขา")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "covid" :
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/43638b97-bec8-4d81-b6fc-b42a21a0f7d2"
